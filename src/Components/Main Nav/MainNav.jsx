...
const MainNav = () => {
  return (
    <div className='flex mb-2'>
        ...
        <div className='links flex ml-14 space-x-4 mt-3 lg:space-x-10 lg:mt-6 lg:ml-80'>
        ...
        <div  className='buttons flex ml-10 space-x-1 mt-3 lg:ml-80 lg:space-x-6 lg:mt-6'>
